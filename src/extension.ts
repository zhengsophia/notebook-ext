...
export function activate(context: vscode.ExtensionContext) {
  ...
  // ~~~~~ backend server functionality - extracted to TreeViewProvider ~~~~~~~
  // initialization case : extension is first activated to an open notebook
  // const activeEditor = vscode.window.activeNotebookEditor;
  // if (activeEditor) {
  //     processNotebook(activeEditor);
  // }

  // // rerun when the active notebook editor changes
  // vscode.window.onDidChangeActiveNotebookEditor((editor) => {
  //     if (editor) {
  //         processNotebook(editor);
  //     }
  // });

  // async function processNotebook(editor: any) {
  //     try {
  ...
  // ~~~~~ backend server functionality -> on command ~~~~~~~
